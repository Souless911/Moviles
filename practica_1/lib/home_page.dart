...
import 'bloc/shazam_api_event.dart';
import 'bloc/shazam_api_state.dart';
...
class _HomePageState extends State<HomePage> {
  String actualText = 'Toque para escuchar';
  @override
                ...
                child: BlocConsumer<ShazamApiBloc, ShazamApiState>(
                  listener: (context, state) {
                    if (state is ShazamListeningState) {
                      actualText = 'Escuchando...';
                    } else if (state is ShazamFindedState) {
                      actualText = 'Toque para escuchar';
                        ...
                        child: Material(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                shape: BoxShape.circle,
                                color: Color.fromARGB(255, 255, 255, 255)),
                            child: Image.asset('assets/youtube_music.png',
                                height: 10),
                          ),
                        ),
                      );
